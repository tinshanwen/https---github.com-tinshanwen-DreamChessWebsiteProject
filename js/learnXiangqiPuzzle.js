...
const pieces = {
  ...
  //-----------------------------------------------------------------------
    ...
    let move = 1;
    let puzzle = [];
    let puzzle1 =   [   "r1eagaehr/9/hc5c1/s1s1C1s1s/9/7C1/S1S1S1S1S/9/9/RHEAGAEHR r",
                        "r1eagaehr/9/hc5c1/s1s1C1s1s/9/4C4/S1S1S1S1S/9/9/RHEAGAEHR r"
                    ];
    let puzzle2 =   [   "2eag1ehr/r3a4/1ch4c1/s1C1s1s1s/9/9/S1S1S1S1S/2H4C1/9/R1EAGAEHR r",
                        "2Cag1ehr/r3a4/1ch4c1/s3s1s1s/9/9/S1S1S1S1S/2H4C1/9/R1EAGAEHR r"
                    ];
    let puzzle3 =   [   "1heg1ae1r/4aR3/4c2Ch/s1s1C1s1s/9/9/SrS1S1S1S/2H6/5R3/2EAGAEc1 r",
                        "1heg1Re1r/4a4/4c2Ch/s1s1C1s1s/9/9/SrS1S1S1S/2H6/5R3/2EAGAEc1 r",
                        "1heg1ae1r/9/4c2Ch/s1s1C1s1s/9/9/SrS1S1S1S/2H6/5R3/2EAGAEc1 r",
                        "1heg1ae1r/9/4c2Ch/s1s1C1s1s/9/9/SrS1S1S1S/2H6/3R5/2EAGAEc1 r",
                        "1heg1ae1r/9/3c3Ch/s1s1C1s1s/9/9/SrS1S1S1S/2H6/3R5/2EAGAEc1 r",
                        "1heg1ae1r/9/3R3Ch/s1s1C1s1s/9/9/SrS1S1S1S/2H6/9/2EAGAEc1 r",
                        "1he1gae1r/9/3R3Ch/s1s1C1s1s/9/9/SrS1S1S1S/2H6/9/2EAGAEc1 r",
                        "1he1gae1r/9/3RC3h/s1s1C1s1s/9/9/SrS1S1S1S/2H6/9/2EAGAEc1 r"
                    ];
    ...
    function changePuzzle() {
      ...
      enableDragEvents();
        ...
        if (puzzleNumber == 1) {
          updateBoardFromFEN(puzzle1[0]);
          puzzle = puzzle1;
        } else if (puzzleNumber == 2){
          updateBoardFromFEN(puzzle2[0]);
          puzzle = puzzle2;
        } else if (puzzleNumber == 3){
          updateBoardFromFEN(puzzle3[0]);
          puzzle = puzzle3;
        }
    }
    ...
    function changePlayer() {
      if (boardToFEN() == puzzle[move]) {
        ...
        if (puzzle[move]) {
          ...
          setTimeout(() => (updateBoardFromFEN(puzzle[move])), 1000);
