      ...
      for (let i = 0; i < fenRow.length; i++) {
          ...
          if (!isNaN(char)) {
              ...
              switch (char.toLowerCase()) {
                  case 'g':
                      pieceType = 'general';
                      img.src = char === 'g' ? '../image/blackGeneral.png' : '../image/redGeneral.png';
                      break;
                  case 'a':
                      pieceType = 'advisor';
                      img.src = char === 'a' ? '../image/blackAdvisor.png' : '../image/redAdvisor.png';
                      break;
                  case 'e':
                      pieceType = 'elephant';
                      img.src = char === 'e' ? '../image/blackElephant.png' : '../image/redElephant.png';
                      break;
                  case 'h':
                      pieceType = 'horse';
                      img.src = char === 'h' ? '../image/blackHorse.png' : '../image/redHorse.png';
                      break;
                  case 'r':
                      pieceType = 'chariot';
                      img.src = char === 'r' ? '../image/blackChariot.png' : '../image/redChariot.png';
                      break;
                  case 'c':
                      pieceType = 'cannon';
                      img.src = char === 'c' ? '../image/blackCannon.png' : '../image/redCannon.png';
                      break;
                  case 's':
                      pieceType = 'soldier';
                      img.src = char === 's' ? '../image/blackSoldier.png' : '../image/redSoldier.png';
                      break;
                  default:
