...
<html>
  <head>
    ...
    <script src="../js/chessHistory.js" defer></script>
  ...
  <body>
    ...
    <div>
      <button id="previousMove"> <span>&lt</span> </button>
      <button id="nextMove"><span>&gt</span></button>
    </div>
    <div><button id="flipButton"><span>Flip Board</span></button></div>
    <div><button onclick="window.history.back()"><span>Back</span></button></div>
  </body>
</html>