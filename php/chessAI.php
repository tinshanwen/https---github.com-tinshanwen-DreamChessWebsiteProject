...
<html>
  <head>
    ...
    <script src="../js/chessAI.js" defer></script>
  ...
  <body>
    ...
    <div>
        <button id="lv1" class="button-highlight">Level 1</button>
    ...
    <div id="promotionSelector">
      <button value="queen">Queen</button>
      <button value="rook">Rook</button>
      <button value="bishop">Bishop</button>
      <button value="knight">Knight</button>
    </div>
    <div><button onclick="window.location.href='../php/xiangqiAI.php'"><span>Xiang Qi AI</span></button></div>
  </body>
</html>
